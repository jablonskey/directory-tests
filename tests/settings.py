...
DIRECTORY_BUYER_API_URL = os.environ.get("DIRECTORY_BUYER_API_URL", '')
...
MAILGUN_SSO_DOMAIN = os.environ.get("MAILGUN_SSO_DOMAIN", '')
MAILGUN_SSO_EVENTS_URL = "https://api.mailgun.net/v3/%s/events" % MAILGUN_SSO_DOMAIN
MAILGUN_SSO_API_USER = "api"
MAILGUN_SSO_SECRET_API_KEY = os.environ.get("MAILGUN_SSO_SECRET_API_KEY")
MAILGUN_DIRECTORY_DOMAIN = os.environ.get("MAILGUN_DIRECTORY_DOMAIN")
MAILGUN_DIRECTORY_EVENTS_URL = "https://api.mailgun.net/v3/%s/events" % MAILGUN_DIRECTORY_DOMAIN
MAILGUN_DIRECTORY_API_USER = "api"
MAILGUN_DIRECTORY_SECRET_API_KEY = os.environ.get("MAILGUN_DIRECTORY_SECRET_API_KEY")
